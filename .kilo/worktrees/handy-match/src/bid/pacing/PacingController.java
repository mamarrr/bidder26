...
import static bid.config.BidStrategyConfig.CONTROL_STEP;
import static bid.config.BidStrategyConfig.EARLY_RED_ROUND_GUARD;
import static bid.config.BidStrategyConfig.FLOOR_SPEND_RATIO;
import static bid.config.BidStrategyConfig.GREEN_LAG_RATIO;
import static bid.config.BidStrategyConfig.INTERNAL_TARGET_BUFFER_RATIO;
import static bid.config.BidStrategyConfig.NEAR_FLOOR_STABILITY_RATIO;
import static bid.config.BidStrategyConfig.ORANGE_LAG_RATIO;
import static bid.config.BidStrategyConfig.RED_EXIT_SPEND_LAG_RATIO_OF_FLOOR;
import static bid.config.BidStrategyConfig.TARGET_ROUNDS_TO_HIT_FLOOR;
import static bid.config.BidStrategyConfig.TARGET_SPEND_LOWER_GUARD_RATIO;
import static bid.config.BidStrategyConfig.TARGET_SPEND_UPPER_GUARD_RATIO;
import static bid.config.BidStrategyConfig.YELLOW_EXIT_SPEND_LAG_RATIO_OF_FLOOR;
import static bid.config.BidStrategyConfig.YELLOW_LAG_RATIO;
