...
import static bid.config.BidStrategyConfig.AGE_13_17_PENALTY;
import static bid.config.BidStrategyConfig.AGE_18_24_BONUS;
import static bid.config.BidStrategyConfig.AGE_25_34_BONUS;
import static bid.config.BidStrategyConfig.AGE_35_44_BONUS;
import static bid.config.BidStrategyConfig.CHOSEN_CATEGORY;
import static bid.config.BidStrategyConfig.MATCH_INTEREST_1_WEIGHT;
import static bid.config.BidStrategyConfig.MATCH_INTEREST_2_WEIGHT;
import static bid.config.BidStrategyConfig.MATCH_INTEREST_3_WEIGHT;
import static bid.config.BidStrategyConfig.MATCH_VIDEO_WEIGHT;
import static bid.config.BidStrategyConfig.SUBSCRIBED_SCORE;
import static bid.config.BidStrategyConfig.SYNERGY_BONUS;
